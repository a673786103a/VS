...
void test09() {
	...
	print(res);
	//第二种 inserter
	unique_copy(ivec.begin(), ivec.end(), inserter(res,res.begin()+2));//为什么没有去掉重复的？？？
	print(res);
	//第三章 front_inserter
	list<string> ilst;
...
void test10() {
	...
	istream_iterator<string> eof;	//不指定对象，默认代表end-of-file
	vector<string> text;
